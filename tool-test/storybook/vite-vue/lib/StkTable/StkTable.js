...
import { defineComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, createElementVNode, Fragment, renderList, createCommentVNode, createBlock, resolveDynamicComponent, renderSlot, toDisplayString, createTextVNode, pushScopeId, popScopeId } from "vue";
const StkTable_vue_vue_type_style_index_0_scoped_6ea3e66e_lang = "";
...
const _withScopeId = (n) => (pushScopeId("data-v-6ea3e66e"), n = n(), popScopeId(), n);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    ref: "tableContainer",
    class: normalizeClass(["stk-table", { virtual: _ctx.virtual, "virtual-x": _ctx.virtualX, dark: _ctx.theme === "dark" }]),
    style: normalizeStyle(_ctx.virtual && { "--row-height": _ctx.virtualScroll.rowHeight + "px" }),
    onScroll: _cache[4] || (_cache[4] = (...args) => _ctx.onTableScroll && _ctx.onTableScroll(...args))
  }, [
    createElementVNode("table", {
      ...
      createElementVNode("thead", null, [
        (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.tableHeaders, (row, index) => {
          return openBlock(), createElementBlock("tr", {
            key: index,
            onContextmenu: _cache[3] || (_cache[3] = (e) => _ctx.onHeaderMenu(e))
          }, [
            _ctx.virtualX_on ? (openBlock(), createElementBlock("th", {
              key: 0,
              class: "virtual-x-left",
              style: normalizeStyle({
                minWidth: _ctx.virtualScrollX.offsetLeft + "px",
                width: _ctx.virtualScrollX.offsetLeft + "px"
              })
            }, null, 4)) : createCommentVNode("", true),
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.virtualX_on ? _ctx.virtualX_columnPart : row, (col) => {
              return openBlock(), createElementBlock("th", {
                ...
                style: normalizeStyle({
                  ...
                  ..._ctx.fixedStyle("th", col)
                }),
                title: col.title,
                class: normalizeClass([
                  col.sorter ? "sortable" : "",
                  col.dataIndex === _ctx.sortCol && _ctx.sortOrderIndex !== 0 && "sorter-" + _ctx.sortSwitchOrder[_ctx.sortOrderIndex],
                  _ctx.showHeaderOverflow ? "text-overflow" : "",
                  col.headerClassName,
                  col.fixed ? "fixed-cell" : ""
                ]),
                onClick: (e) => {
                  _ctx.onColumnSort(col);
                  _ctx.onHeaderCellClick(e, col);
                },
                onDragstart: _cache[0] || (_cache[0] = (...args) => _ctx.onThDragStart && _ctx.onThDragStart(...args)),
                onDrop: _cache[1] || (_cache[1] = (...args) => _ctx.onThDrop && _ctx.onThDrop(...args)),
                onDragover: _cache[2] || (_cache[2] = (...args) => _ctx.onThDragOver && _ctx.onThDragOver(...args))
              }, [
            ...
            _ctx.virtualX_on ? (openBlock(), createElementBlock("th", {
              ...
              style: normalizeStyle([{ "padding": "0" }, {
                minWidth: _ctx.virtualX_offsetRight + "px",
                width: _ctx.virtualX_offsetRight + "px"
              }])
            }, null, 4)) : createCommentVNode("", true)
          ], 32);
        }), 128))
      ...
      createElementVNode("tbody", null, [
        _ctx.virtual_on ? (openBlock(), createElementBlock("tr", {
          key: 0,
          style: normalizeStyle({ height: `${_ctx.virtualScroll.offsetTop}px` })
        }, null, 4)) : createCommentVNode("", true),
        _ctx.dataSourceCopy && _ctx.dataSourceCopy.length ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.virtual_dataSourcePart, (row, i) => {
            return openBlock(), createElementBlock("tr", {
              key: _ctx.rowKey ? _ctx.rowKeyGen(row) : i,
              "data-row-key": _ctx.rowKey ? _ctx.rowKeyGen(row) : i,
              class: normalizeClass({
                active: _ctx.rowKey ? _ctx.rowKeyGen(row) === (_ctx.currentItem.value && _ctx.rowKeyGen(_ctx.currentItem.value)) : row === _ctx.currentItem.value,
                hover: _ctx.rowKey ? _ctx.rowKeyGen(row) === _ctx.currentHover.value : row === _ctx.currentHover.value
              }),
              onClick: (e) => _ctx.onRowClick(e, row),
              onDblclick: (e) => _ctx.onRowDblclick(e, row),
              onContextmenu: (e) => _ctx.onRowMenu(e, row),
              onMouseover: (e) => _ctx.onTrMouseOver(e, row)
            }, [
              _ctx.virtualX_on ? (openBlock(), createElementBlock("td", _hoisted_8)) : createCommentVNode("", true),
              (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.virtualX_on ? _ctx.virtualX_columnPart : _ctx.tableProps, (col) => {
                return openBlock(), createElementBlock("td", {
                  ...
                  style: normalizeStyle({
                    ...
                    ..._ctx.fixedStyle("td", col)
                  }),
                  onClick: (e) => _ctx.onCellClick(e, row, col)
                }, [
                  ...
                  }, toDisplayString(row[col.dataIndex] ?? _ctx.emptyCellText), 9, _hoisted_10))
                ], 14, _hoisted_9);
              }), 128))
            ], 42, _hoisted_7);
          }), 128)),
          _ctx.virtual_on ? (openBlock(), createElementBlock("tr", {
            key: 0,
            style: normalizeStyle({ height: `${_ctx.virtual_offsetBottom}px` })
          }, null, 4)) : createCommentVNode("", true)
        ], 64)) : createCommentVNode("", true)
      ])
    ], 4),
    (!_ctx.dataSourceCopy || !_ctx.dataSourceCopy.length) && _ctx.showNoData ? (openBlock(), createElementBlock("div", {
      key: 0,
...
const StkTable = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-6ea3e66e"]]);
export {
  StkTable,
